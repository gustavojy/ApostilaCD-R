...
```{r, echo=FALSE, out.width="50%", fig.cap="Esquematização da função $inner_join$. Fonte: R for Data Science, 2017."}
...
```{r, echo=FALSE, out.width="50%", fig.cap="Esquematização da função $full_join$. Fonte: R for Data Science, 2017."}
...
```{r, echo=FALSE, out.width="50%", fig.cap="Esquematização das funções $left_join$ e $right_join$. Fonte: R for Data Science, 2017."}
...
```{r, echo=FALSE, out.width="50%", fig.cap="Esquematização da função $semi_join$. Fonte: R for Data Science, 2017."}
...
```{r, echo=FALSE, out.width="50%", fig.cap="Esquematização da função $anti_join$. Fonte: R for Data Science, 2017."}
